...
img_size = 48
num_channels = 2
train_path = '/media/data2/mhy/data/0927N1'
...
def train(num_iteration):
    ...
    for i in range(total_iterations, total_iterations + num_iteration):
        ...
        if i % 1000 == 0:
            ...
            saver.save(session, '/media/data2/mhy/data/0927N1/modelL6/SimpleFusion.ckpt', global_step=i)
    total_iterations += num_iteration


train(num_iteration=1000001)